        ...
        <div class="mt-auto">
            ...
            <div class="px-4 pt-6 border-t border-gray-100 dark:border-gray-700">
                 <div class="flex items-center mb-4">
                    <img class="object-cover rounded-full h-10 w-10 ring-2 ring-gray-100 dark:ring-gray-700" src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=6366f1&color=fff" alt="avatar" />
                    <div class="ml-3">
                        <h4 class="text-sm font-semibold text-gray-800 dark:text-gray-200 cursor-pointer overflow-hidden truncate w-32" title="{{ Auth::user()->name }}">{{ Auth::user()->name }}</h4>
