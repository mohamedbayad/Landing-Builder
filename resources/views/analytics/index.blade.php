                ...
                <div class="flex flex-wrap items-center gap-2 w-full md:w-auto">
                    ...
                    <div class="relative">
                        <select x-model="filters.landing_id" @change="fetchData()"
                                class="appearance-none pl-3 pr-8 py-2 bg-white dark:bg-[#161B22] border border-gray-300 dark:border-white/[0.06] rounded-lg text-sm font-medium text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-orange/20 focus:border-brand-orange transition-shadow shadow-sm cursor-pointer">
                    ...
                    <button @click="resetFilters()" class="p-2 text-gray-400 hover:text-brand-orange dark:hover:text-brand-orange transition-colors" title="Refresh">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
            ...
            <div x-show="!isLoading"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 bg-white dark:bg-[#161B22] rounded-xl shadow-sm border border-gray-100 dark:border-white/[0.06] p-6 flex flex-col">
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white tracking-tight flex items-center gap-2">
                            ...
                            <button class="text-sm font-medium text-brand-orange hover:text-brand-orange-600 flex items-center gap-1">
                        ...
                        <div class="flex flex-col md:flex-row flex-grow gap-6">
                            ...
                            <div class="w-full md:w-1/3 flex flex-col border-l border-gray-100 dark:border-white/[0.06] pl-0 md:pl-6">
                                <div class="flex justify-between text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-100 dark:border-white/[0.06] pb-2 mb-3">
                                    <span>Country</span>
                                    ...
                                    <template x-for="c in realtimeData.countries.slice(0, 6)" :key="c.country">
                                        <div>
                                            ...
                                            <div class="w-full bg-transparent h-0.5 mt-0.5">
                                                <div class="bg-brand-orange h-0.5" :style="'width: ' + (realtimeData.countries[0] ? (c.count / realtimeData.countries[0].count * 100) : 0) + '%'"></div>
                                            </div>
                                        </div>
                                    </template>
                                ...
                                <div class="pt-3 mt-auto text-right">
                                    <button class="text-sm font-medium text-brand-orange hover:text-brand-orange-600 flex items-center justify-end w-full gap-1">
                    ...
                    <div class="lg:col-span-1 bg-white dark:bg-[#161B22] rounded-xl shadow-sm border border-gray-100 dark:border-white/[0.06] p-6 flex flex-col">
                        <div class="flex justify-between items-start border-b border-gray-100 dark:border-white/[0.06] pb-2 mb-4 relative">
                            <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wider uppercase">
                                Active users in last 30 minutes
                            </h3>
                            <button class="text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 rounded-full p-0.5 absolute right-0 top-0">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
                            </button>
                        </div>
                        ...
                        <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wider uppercase mb-4">
                            Active users per minute
                        </h3>

                        <!-- Minute Bar Chart -->
                        <div class="flex items-end h-24 gap-[2px] w-full border-b border-gray-300 dark:border-white/[0.06] pb-0 mb-6 relative">
                            <template x-for="min in realtimeData.minutes" :key="min.time">
                                <div class="flex-1 bg-orange-100 hover:bg-orange-200 dark:bg-white/[0.04] dark:hover:bg-white/[0.08] transition-colors cursor-pointer group relative h-full flex flex-col justify-end">
                        ...
                        <!-- Top Countries List -->
                        <div class="flex justify-between text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wider uppercase border-b border-gray-200 dark:border-white/[0.06] pb-2 mb-3">
                            ...
                            <template x-for="c in realtimeData.countries.slice(0, 5)" :key="c.country">
                                <div>
                                    ...
                                    <div class="w-full h-px mt-0.5">
                                        <div class="bg-brand-orange h-full" :style="'width: ' + (realtimeData.countries[0] ? (c.count / realtimeData.countries[0].count * 100) : 0) + '%'"></div>
                                    </div>
                                </div>
                            </template>
                            <template x-if="realtimeData.countries.length === 0">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <!-- Sessions -->
                    <div class="bg-white dark:bg-[#161B22] rounded-xl shadow-sm border border-gray-100 dark:border-white/[0.06] p-5 flex flex-col justify-between hover:shadow-md transition-shadow">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6" x-show="data.kpi.has_data">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <!-- Line Chart Card -->
                        <div class="bg-white dark:bg-[#161B22] rounded-xl shadow-sm border border-gray-100 dark:border-white/[0.06] p-6">
                            <div class="flex justify-between items-center mb-6">
                                <h3 class="text-xl font-semibold text-gray-900 dark:text-white tracking-tight">Sessions Overview</h3>
                                <div class="flex items-center gap-2">
                                    <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-orange-50 text-brand-orange dark:bg-orange-500/10">
                                        Docs
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="bg-white dark:bg-[#161B22] rounded-xl shadow-sm border border-gray-100 dark:border-white/[0.06] p-6">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white tracking-tight mb-4">Conversion Funnel</h3>

                            <div class="space-y-4">
                                <template x-for="(step, index) in data.funnel" :key="step.label">
                                    <div class="relative group">
                                        <div class="flex justify-between text-sm mb-1.5 align-middle">
                                            <span class="font-medium text-gray-700 dark:text-gray-300 group-hover:text-brand-orange transition-colors" x-text="step.label"></span>
                                            <span class="font-bold text-gray-900 dark:text-white" x-text="formatNumber(step.value)"></span>
                                        </div>
                                        <div class="w-full bg-gray-100 rounded-full h-3 dark:bg-white/[0.06] overflow-hidden">
                                        ...
                                        <template x-if="step.label === 'CTA Clicks' && data.clicks_breakdown && data.clicks_breakdown.length > 0">
                                            <div class="mt-3 ml-4 pl-3 border-l-2 border-orange-200 dark:border-orange-500/20 space-y-2">
                                                ...
                                                <template x-for="(item, bi) in data.clicks_breakdown" :key="item.label">
                                                    <div class="group/item">
                                                        ...
                                                        <div class="w-full bg-gray-100 dark:bg-white/[0.06] rounded-full h-1.5 overflow-hidden">
                                                            <div class="h-1.5 rounded-full transition-all duration-700 ease-out"
                                                                 :class="bi === 0 ? 'bg-brand-orange' : bi === 1 ? 'bg-blue-400' : 'bg-sky-300'"
                        ...
                        <div class="bg-white dark:bg-[#161B22] rounded-xl shadow-sm border border-gray-100 dark:border-white/[0.06] overflow-hidden">
                            <div class="px-6 py-4 border-b border-gray-100 dark:border-white/[0.06] flex justify-between items-center bg-gray-50/50 dark:bg-white/[0.02]">
                                <h3 class="text-xl font-semibold text-gray-900 dark:text-white tracking-tight">Top Landing Pages</h3>
                                <button class="text-sm text-brand-orange hover:text-brand-orange-600 font-medium">View All</button>
                            </div>
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-100 dark:divide-white/[0.06]">
                                    <thead class="bg-gray-50 dark:bg-white/[0.02]">
                                        <tr>
                                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Page</th>
                                            <th class="px-6 py-3 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Sessions</th>
                                            <th class="px-6 py-3 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Leads</th>
                                            <th class="px-6 py-3 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Conv.</th>
                                            <th class="px-6 py-3 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden sm:table-cell">Duration</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <template x-for="row in data.landing_performance" :key="row.name">
                                            <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-medium text-brand-orange hover:underline cursor-pointer" x-text="row.name"></div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900 dark:text-white" x-text="formatNumber(row.sessions)"></td>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium"
                                                          :class="row.conversion_rate > 5 ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 text-gray-800 dark:bg-white/[0.04] dark:text-gray-300'">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Devices Card -->
                        <div class="bg-white dark:bg-[#161B22] rounded-xl shadow-sm border border-gray-100 dark:border-white/[0.06] p-6">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white tracking-tight mb-4">Device Breakdown</h3>
                            <div class="space-y-5">
                                <!-- Mobile -->
                                <div>
                                    ...
                                    <div class="w-full bg-gray-100 rounded-full h-2 dark:bg-white/[0.06]">
                        ...
                        <!-- Visitor Types -->
                        <div class="bg-white dark:bg-[#161B22] rounded-xl shadow-sm border border-gray-100 dark:border-white/[0.06] p-6">
                            <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">Visitor Trend</h3>
                            <div class="flex items-center justify-between">
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-brand-orange" x-text="data.breakdowns.visitor_types.new + '%'"></div>
                                    <div class="text-xs text-gray-500 mt-1">New</div>
                                </div>
                                <div class="h-8 w-px bg-gray-200 dark:bg-white/[0.06]"></div>
                                <div class="text-center">
                ...
                <div x-show="!data.kpi.has_data && !isLoading" class="mt-12 text-center py-12 bg-white dark:bg-[#161B22] rounded-xl border border-dashed border-gray-300 dark:border-white/[0.06]">
        ...
        function analyticsDashboard() {
            return {
                ...
                getFunnelColor(index) {
                    const classes = ['bg-brand-orange', 'bg-blue-400', 'bg-sky-400', 'bg-emerald-400'];
                ...
                updateD3Map(countriesData) {
                    ...
                    const emptyColor = document.documentElement.classList.contains('dark') ? '#374151' : '#e2e8f0';
